...
c1 = Category.create(name: "REST", category_query: "(REST OR RESTful OR Stateless)")
c2 = Category.create(name: "Ruby", category_query: "(Ruby OR Gems OR \"Ruby-on-Rails\" OR \"Ruby on Rails\" OR ROR OR Sinatra OR Rails OR JRuby)")
c3 = Category.create(name: "Security", category_query: "(security OR selinux OR Iptables OR OpenSSH OR SSH OR penetration OR OpenSCAP OR \"SQL injection\" OR botnet OR BackBox OR BackTrack OR \"Kali Linux\" OR Forensics OR exploit OR Vulnerability)")
c4 = Category.create(name: "REST", category_query: "(\"tech trainer\" OR \"technical trainer\" OR \"tech instructor\" OR \"technical instructor\" OR\"training curriculum\" OR \"training\" OR \"support\")")

u1 = User.create()
q1 = Query.create(name: "Ruby REST", text_of_query: "", user_id: u1.id)
q2 = Query.create(name: "Security trainer", text_of_query: "", user_id: u1.id)
